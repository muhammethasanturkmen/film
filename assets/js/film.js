...
function renderStudents() {
  teknoloji.innerHTML = '<h1>Komedi</h1>';
  korku.innerHTML = '<h1>Romatik</h1>';
  saglik.innerHTML = '<h1>Gerilim</h1>';
  gezi.innerHTML = '<h1>Aksiyon</h1>';
  yemek.innerHTML = '<h1>Bilim Kurgu</h1>';
